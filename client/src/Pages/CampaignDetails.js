              ...
              {donators.length > 0 ? (
                donators.map((item, index) => (
                  <div
                    ...
                    className="flex justify-between items-center gap-4 mr-10"
                  >
        ...
        <div className="flex-1">
          ...
          <div className="mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]">
            ...
            <div className="mt-[30px]">
              ...
              <button
                className=" h-10 w-full bg-[#8c6dfd] p-2 rounded-xl  text-white hover:cursor-pointer hover:bg-purple-700 "
